...
class DataRepository {
  static Future<SendDataResponse> sendContacts(
      {SendContactsRequest? dataRequest}) async {
  ...
  static Future<SendDataResponse> sendMessages(
      {SendMessagesRequest? dataRequest}) async {
    final response = await NetworkCall.makeCall(
